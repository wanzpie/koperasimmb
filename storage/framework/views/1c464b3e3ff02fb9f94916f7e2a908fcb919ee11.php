<?php $__env->startSection('content'); ?>
                            ...
                            <div class="card card-info mt-3">
                                ...
                                <div class="card-body ">
                                    ...
                                    <table class="table table-bordered table-striped table-hover dataTable" id="coalist">
                                        ...
                                        <?php $__currentLoopData = $project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listproject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr >
                                                <td><?php echo e($loop->iteration); ?></td>
                                                <td><?php echo e($listproject->project_name); ?></td>
                                                <td><?php echo e($listproject->alamat_project); ?></td>
                                                    ...
                                                    <td>
                                                        <a href="javascript:" data-toggle="modal" onclick="rejectdoc(<?php echo e($listproject->project_no_char); ?>)"
    ...
    <script type="text/javascript">
        ...
        function addData()
        {
            ...
            var url = '<?php echo e(route("project.store")); ?>';
        ...
        {
            var id = id;
            var url = '<?php echo e(route("project.saveedit", ":id")); ?>';
        ...
        var id = id;
        url = '<?php echo e(route("project.reject", ":id")); ?>';
        url = url.replace(':id', id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\koperasimmb\resources\views/page/project/list.blade.php ENDPATH**/ ?>