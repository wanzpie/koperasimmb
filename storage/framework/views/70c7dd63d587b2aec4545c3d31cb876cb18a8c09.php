<?php $__env->startSection('content'); ?>
                            ...
                            <div class="card card-info mt-3">
                                ...
                                <div class="card-body ">
                                    <div class="row mb-2">
                                        ...
                                        <a href="<?php echo e(route('peminjaman.createspm')); ?>" class="btn bg-gradient-primary  btn-sm">Tambah Pinjaman</a>

                                    </div>
                                    <div class="row"><?php echo $__env->make('layouts.flash-message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                                    ...
                                    <table class="table table-bordered table-hover dataTable" id="listpinjam">
                                        ...
                                        <?php $__currentLoopData = $spmpinjams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spmpinjam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr >
                                                <td><?php echo e($loop->iteration); ?></td>
                                                <td><?php echo e($spmpinjam->spmhd_nochar); ?></td>
                                                <td><?php echo e($spmpinjam->nik_karyawan); ?></td>
                                                <td><?php echo e($spmpinjam->nama_karyawan); ?></td>
                                                <td><?php echo e($spmpinjam->nama_divisi); ?></td>
                                                <td><?php if($spmpinjam->jenis_spmhd=='KRU'): ?>
                                                         Uang
                                                        <?php else: ?>
                                                     Barang 
                                                    <?php endif; ?>
                                                     </td>
                                                <td><?php echo e($spmpinjam->tgl_pengajuan); ?></td>
                                                <td><?php echo e($spmpinjam->spm_period); ?></td>
                                                <td><?php echo e($spmpinjam->spm_catatan); ?></td>
                                                <td><?php echo e($spmpinjam->spmhd_nominal); ?></td>
                                                <td><?php echo e($spmpinjam->spm_status); ?></td>

                                                    
                                                        <?php if($spmpinjam->is_generate==0): ?>
                                                        <td>
                                                        <a href="javascript:" data-toggle="modal" onclick="spmsaveedit(<?php echo e($spmpinjam->id_spmhd); ?>)"
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:" data-toggle="modal" onclick="generatesch(<?php echo e($spmpinjam->id_spmhd); ?>)"
                                                            data-target="#GenerateModal" class="btn btn-xs bg-gradient-info generatedoc">generate
                                                        </a>
                                                    </td> 
                                                        <td>
                                                            <a href="javascript:" data-toggle="modal" onclick="rejectdoc(<?php echo e($spmpinjam->id_spmhd); ?>)"
                                                    ...
                                                    <?php else: ?>
                                                     <td>
                                                    <a href="<?php echo e(route('peminjaman.spmupdate', $spmpinjam->id_spmhd)); ?>" class="btn bg-gradient-warning btn-xs disabled">edit</a>
                                                     
                                                     </td>
                                                     <td>

                                                    <a href="<?php echo e(route('peminjaman.spmupdate', $spmpinjam->id_spmhd)); ?>" class="btn bg-gradient-info btn-xs disabled">generated</a>
                                                </td>
                                                <td>
                                                    <a href="<?php echo e(route('peminjaman.spmdelete', $spmpinjam->id_spmhd)); ?>" class="btn bg-gradient-danger btn-xs disabled">delete</a>
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        ...
                                                                        <input type="hidden" class="form-control form-control-sm" name="id_project" id="id_project"value="<?php echo e($id_project); ?>" >
    ...
    <script type="text/javascript">
        ...
        {
            var id = id;
            var url = '<?php echo e(route("peminjaman.spmupdate", ":id")); ?>';
        ...
        {
            var id = id;
            var url = '<?php echo e(route("peminjaman.generatesch", ":id")); ?>';
            url = url.replace(':id', id);
        ...
        {
            var id = id;
            var url = '<?php echo e(route("peminjaman.inactive", ":id")); ?>';
            url = url.replace(':id', id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\koperasimmb\resources\views/page/simpanpinjam/listsimpanpinjam.blade.php ENDPATH**/ ?>