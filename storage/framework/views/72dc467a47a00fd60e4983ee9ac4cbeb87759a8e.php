                            ...
                            <div class="card card-info mt-3">
                                ...
                                <div class="card-body ">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="row"> <h3>bagi Hasil  SHU tahun </h3><br></div>
                                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover dataTable nowrap" id="listshu">
                                            ...
                                            <?php $__currentLoopData = $datashu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr >
                                                    ...
                                                    <td><?php echo e($agt->jum_simpo); ?></td>
                                                    <td><?php echo e($agt->jum_simp_sr); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\koperasimmb\resources\views/page/shu/rshulist.blade.php ENDPATH**/ ?>