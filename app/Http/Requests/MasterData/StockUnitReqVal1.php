...
class StockUnitReqVal1 extends Request {
	...
	public function rules()
	{
        ...
        public function messages() 
        {
            return[
                   ...
                   'IS_HOEK.required' => 'HOEK required',
                   ...
                   'BLOK_NAME.required'=>'Blok required',
                   'SEKTOR_NAME.required'=>'Sektor required'
            ];
        }
