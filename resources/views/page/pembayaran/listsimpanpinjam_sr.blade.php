                                                ...
                                                <td>{{ $spmsr->spmhd_nominal }}</td>
                                                    ...
                                                    <td>
                                                        <a href="javascript:" data-toggle="modal" onclick="approvedocpermit({{ $listproject->PROJECT_NO_CHAR}})"
                                                           data-target="#DeleteModal" class="btn btn-xs bg-gradient-info updatedoc"><i class="fa fa-edit" title="Edit " ></i>Edit</a>

{{--                                                        <a href="{{ route('project.edit', $listproject->PROJECT_NO_CHAR) }}" class="btn  btn-xs bg-gradient-success">Edit</a></td>--}}
                                                    <td>
                                                        <a href="{{ route('simpanan_sr.destroy', $spmsr->id_anggota) }}" class="btn  btn-xs bg-gradient-danger ">Disable</a>
                                                    </td>
                                            </tr>
